...
Что было сделано:
1. Создал 2 новых класса ActivityCompositionRoot и ControllerCompositionRoot для разделения скопа видимости зависимостей.
2. Добавил новый класс StateStore для хранения необходимых состояний.
3. Внёс изменения в ScreenNavigator, теперь он не хранит выбранную позицию.
4. Добавил диалоговое окно с предупреждением перед удалением данных.
5. Переделал ввод и редактирование данных через диалоговое окно.
6. Сделано много других изменений под капотом.

## Portrait mode
![portrait](images/homework11_portrait.png)